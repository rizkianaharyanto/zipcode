        ...
        foreach ($seeker as $index => $data) {
            if (str_replace(" ", "", strtoupper($data['name'])) == $snitch_up && strlen($data['code']) == 2) {
                ...
                $hasil = array_merge(
                    ...
                    array("City/Kab Name" => $post['City/Kab Name']),
                    array("Kec/subDistrict" => $post['Kec/subDistrict']),
                    array("Kelurahan/village" => $post['Kelurahan/village']),
                    array("Postal Code" => $post['Postal Code']),
                );
